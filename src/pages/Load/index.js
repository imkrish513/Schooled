            ...
            <View style={styles.container}>
                        ...
                        <View style={styles.modalOptions}>
                            <View style={styles.modalHeader}>
                                ...
                                <View style={styles.modalExitContainer}>
                                    <Text style={styles.closeModal} onPress={() => setShowOptions(false)}>Cancel</Text>
                                </View>
                            </View>
...

                {
                    quizzes !== null ?
                        ...
                        :
                            <Text>You haven't created any quiz yet :(</Text>
                    :
                        <Text>You haven't created a quiz yet :(</Text>
                }
