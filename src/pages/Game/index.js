                        ...
                        <View style={styles.container}>
                            <View style={styles.header}>
                                ...
                                <View style={styles.questionHeader}>
                                    <Text style={styles.questionCount}>Question {questionIndex}/{questionQnt}</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.footer}>
                                <TouchableOpacity onPress={() => nextStep()}>
                                    <View style={styles.btnFinish}>
                                        <Text style={styles.btnFinishText}>Next</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                        </View>
                                    ...
                                    correctAnswers === questionQnt ?
                                        <View style={styles.boxCongrat}>
                                            <View style={styles.congratContainer}>
                                                <Text style={styles.congratText}>Fantastic!</Text>
                                            </View>
                                            <View style={styles.pointContainer}>
                                                ...
                                                <View style={styles.pointInfo}>
                                                    <Text>You got {correctAnswers} out of {questionQnt} questions right.</Text>
                                                </View>
                                            </View>
                                        </View>
                                    :
                                        correctAnswers >= ((questionQnt/2) + 1) && correctAnswers < questionQnt ?
                                            <View style={styles.boxCongrat}>
                                                <View style={styles.congratContainer}>
                                                    <Text style={styles.congratText}>Very good!</Text>
                                                </View>
                                                <View style={styles.pointContainer}>
                                                    <View style={styles.pointIconBox}>
                                                        <Feather name="thumbs-up" size={86} style={styles.pointIcon}/>
                                        ...
                                        :
                                            correctAnswers < ((questionQnt/2) + 1) && correctAnswers > 0 ?
                                                <View style={styles.boxCongrat}>
                                                    <View style={styles.congratContainer}>
                                                        <Text style={styles.congratText}>Keep practicing!</Text>
                                                    </View>
                                                    <View style={styles.pointContainer}>
                                                        <View style={styles.pointIconBox}>
                                                            <Feather name="thumbs-up" size={86} style={styles.pointIcon}/>
                                            ...
                                            :
                                                correctAnswers === 0 ?
                                                    <View style={styles.boxCongrat}>
                                                        <View style={styles.congratContainer}>
                                                            <Text style={styles.congratText}>Don't give up!</Text>
                                                        </View>
                                                        <View style={styles.pointContainer}>
                                                            <View style={styles.pointIconBox}>
                                                                <Feather name="thumbs-up" size={86} style={styles.pointIcon}/>
                                    ...
                                    <View style={styles.doneContainer}>
                                        <TouchableOpacity onPress={() => returnButton()}>
                                            <View style={styles.btnDone}>
                                                <Text style={styles.btnDoneText}>Finish</Text>
                                            </View>
                                        </TouchableOpacity>
                                    </View>
